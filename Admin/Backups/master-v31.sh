...
# Log local test run duration to Graphite
...
# Log current error count to Graphite
ErrorCnt=$(grep -i -E 'error|unhandled|fail|caught|invalid|undefined|timeout' ./logs/$1.$2.msg.log | wc -l)
