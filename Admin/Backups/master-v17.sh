...
# Set Sitespeed directives
ChromeNative="--browser chrome --connectivity.profile native --viewPort \"1366x768\" --browsertime.connectivity.alias LAN"

ChromeLTE="--browser chrome --connectivity.profile custom --viewPort \"376x812\" --browsertime.connectivity.alias LTE --connectivity.downstreamKbps 12000 --connectivity.upstreamKbps 12000 --connectivity.rtt 35 --browsertime.connectivity.engine=throttle --chrome.CPUThrottlingRate 4"

Chrome3G="--browser chrome --connectivity.profile custom --viewPort \"376x812\" --browsertime.connectivity.alias 3G --connectivity.downstreamKbps 1600 --connectivity.upstreamKbps 768 --connectivity.rtt 150 --browsertime.connectivity.engine=throttle --chrome.CPUThrottlingRate 4"

MobileDevice="--browsertime.chrome.mobileEmulation.deviceName \"iPhone X\""
DesktopDevice="--logToFile true"
  ...
  do
    ...
    case $1 in
        tld) docker run \
             ...
             sitespeedio/sitespeed.io:21.5.0 \
             $SitespeedDirs \
             "$AddDirs" \
             --visualMetrics true \
             --speedIndex true \
