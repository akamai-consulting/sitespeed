...
teststart=`date +%s`
echo "|=============================================================================="
echo "| Mobile start: $(TZ='America/New_York' date): $0 $@"
echo "|=============================================================================="
docker run \
 --rm --name $2-`date +%s` \
...
echo "|=============================================================================="
echo "| Desktop start: $(TZ='America/New_York' date): $0 $@"
echo "|=============================================================================="
docker run \
 --rm --name $2-`date +%s` \
 -e TZ=America/New_York \
...
echo "sitespeed_log.$3.$graphdir.$2.duration $runtime `date +%s`" | nc graphite.$Domain 2003
